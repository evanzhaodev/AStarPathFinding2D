...
public class Grid : MonoBehaviour
{
    ...
    public bool showGridCellsGizmos = false;
    ...
    public Node NodeFromWorldPoint(Vector3 worldPosition)
    {
        ...
        int indexX = Mathf.FloorToInt((worldPosition.x - bottomLeft.x) / nodeDiameter);
        int indexY = Mathf.FloorToInt((worldPosition.z - bottomLeft.z) / nodeDiameter);
        indexX = Mathf.Clamp(indexX, 0, gridSizeX - 1);
        indexY = Mathf.Clamp(indexY, 0, gridSizeY - 1);
    ...
    private void OnDrawGizmos()
    {
        ...
        if (grid != null && showGridCellsGizmos)
        {
            for (int x = 0; x < gridSizeX; x++)
            {
                for (int y = 0; y < gridSizeY; y++)
